...
const Banner = () => {
  return (
    <section className="bg-white ">
      <div className="container grid grid-cols-1 md:grid-cols-2 space-y-2 md:space-y-0 gap-10">
        {/* imagesection */}
        ...
        <motion.img
            ...
            src="https://raw.githubusercontent.com/dilshad-ahmed/creative-fanta/main/src/assets/Banner/juice.png"
            alt=""
            className="w-[300px] md:w-[400px] relative mx-auto z-10"
          />
          <motion.img
            initial={{ opacity: 0, y: -100, rotate: -180, scale: 0 }}
            whileInView={{ opacity: 1, y: 0, rotate: 0, scale: 1 }}
            transition={{ duration: 1.2, delay: 0.2, ease: "easeInOut" }}
            src="https://raw.githubusercontent.com/dilshad-ahmed/creative-fanta/main/src/assets/Banner/splash.png"
            alt=""
        ...
        <div className="flex flex-col justify-center">
          <div className="text-justify md:text-left space-y-4 lg:max-w-[450px]">
          <motion.h1
              variants={fadeUp(0.7)}
              initial="hidden"
              whileInView="show"
